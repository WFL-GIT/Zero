...
class Message(models.Model):
    msg = models.TextField(verbose_name='正文', blank=True, null=True)
    body = models.TextField()
    username = models.CharField(max_length=50)
    nickname = models.CharField(max_length=50, default="匿名")
    msgtime = models.DateTimeField(verbose_name='msg时间', default=now)
    ...
    class Meta:
        ordering = ['username']
        verbose_name = 'msg'  # 指定后台显示模型名称
        verbose_name_plural = 'msg列表'  # 指定后台显示模型复数名称
        db_table = "msg"  # 数据库表名
